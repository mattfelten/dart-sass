...
class AsyncEnvironment {
  ...
  /// were `@use`d.
  List<AsyncModule> get allModules => UnmodifiableListView(_allModules);
  ...
  Value _getVariableFromGlobalModule(String name) {
    ...
    return _fromOneModule("variable", name, (module) => module.variables[name]);
  }
  ...
  bool variableExists(String name) {
    try {
      ...
      // If [getVariable] throws an error because of multiple definitions from
      // multiple modules, that still counts as the variable being defined.
      return true;
    }
  }
  ...
  bool globalVariableExists(String name) {
    ...
    if (_globalModules == null) return false;
    return _globalModules.any((module) => module.variables.containsKey(name));
  }
  ...
  bool functionExists(String name) {
    try {
      ...
      // If [getFunction] throws an error because of multiple definitions from
      // multiple modules, that still counts as the function being defined.
      return true;
    }
  }
  ...
  bool mixinExists(String name) {
    try {
      return getMixin(name) != null;
    } on SassScriptException {
      // If [getMixin] throws an error because of multiple definitions from
      // multiple modules, that still counts as the mixin being defined.
      return true;
    }
  }
